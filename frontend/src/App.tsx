...
function AuthScreen({
  ...
  const handleDemoLogin = () => {
    onAuth(
      { id: "mock-user-id", name: "Demo User", email: "demo@alino.com" },
      "mock-jwt-token",
    );
    navigate("/dashboard");
  };
  ...
  return (
    <main className="auth-page">
      ...
      <section className="auth-card">
        ...
        <div className="demo-hint" onClick={handleDemoLogin} style={{ cursor: "pointer" }}>
          🧪 <strong>Demo:</strong> Email & password are prefilled. Just click Login.
        </div>
      </section>
    </main>
  );
